...
public class URamp implements PrimitiveList {
    ...
    public boolean update(ParameterList pl, SunflowAPI api) {
        ...
        if (b != null && c != null) {
            Point3 v0 = center;
            Point3 v1 = b;//new Point3(b.x, b.y + (float) Utils.rndRng(0, 100), b.z);
            Point3 v2 = c;//new Point3(c.x, c.y + (float) Utils.rndRng(0, 100), c.z);
    ...
    public void prepareShadingState(ShadingState state) {
        //System.out.println("-----------------------------> prepareShadingState");
        state.init();
