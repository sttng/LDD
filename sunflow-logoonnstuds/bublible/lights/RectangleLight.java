...
public class RectangleLight extends TriangleMesh implements Shader {
    ...
    public void init(SunflowAPI api) {
        String name = "rectangularLight" + Utils.rndRng(0, 100) + Utils.rndRng(0, 100) + Utils.rndRng(0, 100);
    ...
    private class TriangleLight implements LightSource {
        ...
        private final int tri3;
        private final float area;
        private final Vector3 ng;
        ...
        private boolean intersectTriangleKensler(Ray r) {
        ...
        public void getSamples(ShadingState state) {
            ...
            float areaB = alpha + beta + gamma - (float) Math.PI;
            ...
            Color c = Color.mul(areaB / samples, radiance);
            for (int i = 0; i < samples; i++) {
                ...
                float phi = (float) randX * areaB - alpha + (float) Math.PI;
                ...
                // make sure the sample is in the right hemisphere - facing in the right direction
