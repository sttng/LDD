...
public final class Matrix4 {
    ...
    /**
     * Creates LDD brick matrix from the specified string containing 12 float
     * numbers. The matrix is given in column major form.
     *
     * @param s a 12 element string in column major form
     * @return a new Matrix4 object
     */
    public final static Matrix4 parseFrom4x3String(String s) {
        String[] arrstring = s.split(",");
        Matrix4 m = new Matrix4();

        m.m00 = Float.parseFloat(arrstring[0]);
        m.m10 = Float.parseFloat(arrstring[1]);
        m.m20 = Float.parseFloat(arrstring[2]);
        m.m30 = 0f;

        m.m01 = Float.parseFloat(arrstring[3]);
        m.m11 = Float.parseFloat(arrstring[4]);
        m.m21 = Float.parseFloat(arrstring[5]);
        m.m31 = 0f;

        m.m02 = Float.parseFloat(arrstring[6]);
        m.m12 = Float.parseFloat(arrstring[7]);
        m.m22 = Float.parseFloat(arrstring[8]);
        m.m32 = 0f;

        m.m03 = Float.parseFloat(arrstring[9]);
        m.m13 = Float.parseFloat(arrstring[10]);
        m.m23 = Float.parseFloat(arrstring[11]);
        m.m33 = 1f;
    ...
    public final String toRealString() {
        ...
        s += Float.toString(this.m00) + ", ";
        s += Float.toString(this.m01) + ", ";
        s += Float.toString(this.m02) + ", ";
        s += Float.toString(this.m03) + ", ";
        s += Float.toString(this.m10) + ", ";
        s += Float.toString(this.m11) + ", ";
        s += Float.toString(this.m12) + ", ";
        s += Float.toString(this.m13) + ", ";
        s += Float.toString(this.m20) + ", ";
        s += Float.toString(this.m21) + ", ";
        s += Float.toString(this.m22) + ", ";
        s += Float.toString(this.m23) + ", ";
        s += Float.toString(this.m30) + ", ";
        s += Float.toString(this.m31) + ", ";
        s += Float.toString(this.m32) + ", ";
        s += Float.toString(this.m33);
