...
public class UberShader implements Shader {
    ...
    public Color getDiffuse(ShadingState state) {
        return diffmap == null ? Shaders.getMixture(state, diff, "uber") : Color.blend(Shaders.getMixture(state, diff, "uber"), diffmap.getPixel(state.getUV().x, state.getUV().y), diffBlend);
    }

    public Color getSpecular(ShadingState state) {
        return specmap == null ? Shaders.getMixture(state, spec, "uber") : Color.blend(Shaders.getMixture(state, spec, "uber"), specmap.getPixel(state.getUV().x, state.getUV().y), specBlend);
    }
