...
public class GlassShader implements Shader {
    ...
    public boolean update(ParameterList pl, SunflowAPI api) {
        dacolor = pl.getColor("color", dacolor);
    ...
    public Color getRadiance(ShadingState state) {
        ...
        float pPara = (cosTheta1 - effectiveEta * cosTheta2) / (cosTheta1 + effectiveEta * cosTheta2);
        float pPerp = (effectiveEta * cosTheta1 - cosTheta2) / (effectiveEta * cosTheta1 + cosTheta2);
        ...
        // refracted ray
        Color color = Shaders.getMixture(state, dacolor, "glass");
        ...
        Color semifinal = absorbtion != null ? ret.mul(absorbtion) : ret;
        return Shaders.getMixture(state, semifinal, "glass");
    }
