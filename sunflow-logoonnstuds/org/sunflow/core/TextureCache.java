...
public final class TextureCache {
    ...
    public static ResourceLocator sl;
    ...
    public synchronized static Texture getTexture(String filename, boolean isLinear) {
        if (textures.containsKey(filename)) {
        	...
        	String f = filename.substring(9);
        	UI.printInfo(Module.TEX, "Using resource \"%s\" ...", f);
        	
  	        Texture t = new Texture(sl.getResource(f), isLinear);
