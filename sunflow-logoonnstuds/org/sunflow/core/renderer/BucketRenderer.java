...
public class BucketRenderer implements ImageSampler {
    ...
    public void render(Display display) {
        ...
        /*try {
         Color[] cl = Utils.addTextWatermarkStream(imageWidth, imageWidth);
         } catch (IOException ex) {
         Logger.getLogger(BucketRenderer.class.getName()).log(Level.SEVERE, null, ex);
         }*/
        /*try {
         display.imageUpdate(0, 0, imageWidth, imageWidth, Utils.addTextWatermarkStream(imageWidth, imageWidth));
         } catch (IOException ex) {
         Logger.getLogger(BucketRenderer.class.getName()).log(Level.SEVERE, null, ex);
         }*/
        /*try {    
         Utils.addTextWatermarkStream(imageWidth, imageHeight, display, renderThreads);
         } catch (IOException ex) {
         Logger.getLogger(BucketRenderer.class.getName()).log(Level.SEVERE, null, ex);
         }*/
        try {
            Watermark.addText(imageWidth, imageHeight, display, renderThreads);
        } catch (IOException ex) {
            Logger.getLogger(BucketRenderer.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        UI.taskStop();
        timerB.end();
        UI.printInfo(Module.BCKT, "Render time: %s", timerB.toString());
        display.imageEnd();
    }
    ...
    private void renderBucket(Display display, int bx, int by, int threadID, IntersectionState istate) {
        ...
        // update pixels
        //Utils.setImage(x0, y0, bw, bh, bucketRGB);
        Watermark.setImage(x0, y0, bw, bh, bucketRGB);
