...
public class ParameterList {
    ...
    /**
     * Add the specified string as a parameter. <code>null</code> values are not
     * permitted.
     *
    ...
    /**
     * Add the specified float as a parameter. <code>null</code> values are not
     * permitted.
     *
     * @param name parameter name
     * @param value parameter value
    ...
    /**
     * Add the specified color as a parameter. <code>null</code> values are not
     * permitted.
     *
     * @param name parameter name
     * @param value parameter value
    ...
    /**
     * Add the specified floats as a parameter. <code>null</code> values are not
     * permitted.
     *
     * @param name parameter name
    ...
    /**
     * Add the specified points as a parameter. <code>null</code> values are not
     * permitted.
     *
     * @param name parameter name
     * @param interp interpolation type
